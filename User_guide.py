...
def user_guide():
    ...
    Label(new_root,text="   ")
    Label(new_root,text="Selection of Calculation Mode:",font=head_font,bg="#FFE9E3").grid(row=1,column=1,sticky='nw')
    Label(new_root,text="* Determine the type of result you want to calculate.",font=body_font,bg="#FFE9E3").grid(row=2,column=1,sticky='nw')
    Label(new_root,text="* If you want to calculate the total GPA of a class for a semester, select 'SGPA' (Semester Grade Point Average).",font=body_font,bg="#FFE9E3").grid(row=3,column=1,sticky='nw')
    Label(new_root,text="* If you want to calculate the combined GPA of the cumulative semesters of the class, select 'CGPA'",font=body_font,bg="#FFE9E3").grid(row=4,column=1,sticky='nw')
    Label(new_root,text="SGPA Calculation:",font=head_font,bg="#FFE9E3").grid(row=5,column=1,sticky='nw')
    Label(new_root,text="* If SGPA is selected:",font=spl_body_font,bg="#FFE9E3").grid(row=6,column=1,sticky='nw')
    Label(new_root,text="a. To calculate regular results, select 'Regular'.",font=body_font,bg="#FFE9E3").grid(row=7,column=1,sticky='nw')
    Label(new_root,text="b. Upload the regular result PDF provided by the university.",font=body_font,bg="#FFE9E3").grid(row=8,column=1,sticky='nw')
    #Label(new_root,text="b. Upload the regular result PDF provided by the university.",font=body_font,bg="#FFE9E3").grid(row=8,column=1,sticky='nw')
    Label(new_root,text="c. Click on the 'Submit' button to initiate the calculation process.",font=body_font,bg="#FFE9E3").grid(row=10,column=1,sticky='nw')
    Label(new_root,text="d. Browse the location where you want to save the calculated GPA file.",font=body_font,bg="#FFE9E3").grid(row=11,column=1,sticky='nw')
    Label(new_root,text="e. Upon completion of file creation, a pop-up will be generated, confirming the successful calculation.",font=body_font,bg="#FFE9E3").grid(row=12,column=1,sticky='nw')
    Label(new_root,text="f. To update regular results with supplementary or revaluation results, select 'Revaluation/Supplementary'.",font=body_font,bg="#FFE9E3").grid(row=13,column=1,sticky='nw')
    Label(new_root,text="g. Upload the Revaluation/Supplementary result PDF provided by the university.",font=body_font,bg="#FFE9E3").grid(row=14,column=1,sticky='nw')
    Label(new_root,text="h. Along with that, upload the regular GPA file obtained previously.",font=body_font,bg="#FFE9E3").grid(row=15,column=1,sticky='nw')
    Label(new_root,text="i. After uploading the result PDF and regular GPA file, browse the location where you want to save the output file.",font=body_font,bg="#FFE9E3").grid(row=16,column=1,sticky='nw')
    Label(new_root,text="j. If the supplementary exams result is present in the regular file of the next batch, directly upload the file like the",font=body_font,bg="#FFE9E3").grid(row=17,column=1,sticky='nw')
    Label(new_root,text=" normal supplementary file, but select 'Revaluation/Supplementary'.",font=body_font,bg="#FFE9E3").grid(row=18,column=1,sticky='nw')
    Label(new_root,text="* Points to Remember while Uploading Files:",font=spl_body_font,bg="#FFE9E3").grid(row=19,column=1,sticky='nw')
    Label(new_root,text="a. Ensure that the PDF file ends correctly (the line after credits should be closed), otherwise the file won't support",font=body_font,bg="#FFE9E3").grid(row=20,column=1,sticky='nw')
    ...
    Label(new_root,text="b. If you use an online converter for converting PDF to Excel, ensure that the given input file only contains the",font=body_font,bg="#FFE9E3").grid(row=22,column=1,sticky='nw')
    ...
    Label(new_root,text="CGPA Calculation:",font=head_font,bg="#FFE9E3").grid(row=24,column=1,sticky='nw')
    Label(new_root,text="* If CGPA is selected:",font=spl_body_font,bg="#FFE9E3").grid(row=25,column=1,sticky='nw')
    Label(new_root,text="a. Click on the checkboxes corresponding to the semesters for which you have calculated individual GPA files. This",font=body_font,bg="#FFE9E3").grid(row=26,column=1,sticky='nw')
    Label(new_root,text="selection helps in obtaining the cumulative GPA for all the semesters.",font=body_font,bg="#FFE9E3").grid(row=27,column=1,sticky='nw')
    Label(new_root,text="b. For each selected semester checkbox, upload the respective calculated semester-wise GPA file.",font=body_font,bg="#FFE9E3").grid(row=28,column=1,sticky='nw')
    Label(new_root,text="c. These files contain the GPA data for each individual semester.",font=body_font,bg="#FFE9E3").grid(row=29,column=1,sticky='nw')
    Label(new_root,text="d. After uploading the semester-wise GPA files, browse the location where you want to save the output file.",font=body_font,bg="#FFE9E3").grid(row=30,column=1,sticky='nw')
    Label(new_root,text="e. The output file will include the calculated CGPA for the class.",font=body_font,bg="#FFE9E3").grid(row=31,column=1,sticky='nw')
